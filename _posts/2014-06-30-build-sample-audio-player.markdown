---
layout: post
title:  "Build sample audio player"
date:   2014-06-30 00:00:00 UTC+9
categories: micon, stm32f4discovery
---

# Build sample audio player

 今日はサンプルのオーディオプレーヤを
 Makefileでビルドできるようにする。

 基本は
 Audio_playback_and_record/EWARM/Audio_playback_and_record.ewd
 などのプロジェクトファイルの中をみればなんとなく雰囲気はわかる。

 USB, Fileシステムいろいろライブラリもソースもあるので、
